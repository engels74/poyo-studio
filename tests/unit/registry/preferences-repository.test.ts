...
describe('model preference compatibility', () => {
  test('canonical row wins and new legacy writes use the canonical WAN key', () => {
    ...
    try {
      ...
      expect(repository.save('wan2.7-image-to-video:frame-to-video', { used: true })).toMatchObject(
        {
          entryKey: 'wan2.7-image-to-video:image-to-video',
